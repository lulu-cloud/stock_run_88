...
```json
{
  ...
  "orders": [
    {"ts_code": "xxx", "stock_name": "xxx", "direction": "buy/sell", "quantity": 100, "price": 0.0, "order_type": "limit", "open_get_in": false, "skill_id": "momentum_hunt", "skill_confidence": 0.66, "evolution_mark": "#情绪回暖#", "reason": "xxx"}
  ],
