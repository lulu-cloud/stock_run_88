...
class PartnershipAccountTestCase(unittest.TestCase):
    ...
    def test_recommender_routes_account_commands_before_agent_status(self):
        with patch.object(recommender, "dispatch_partnership_command", return_value="account-status") as dispatch:
    ...
    def test_status_with_agent_id_still_uses_agent_performance(self):
        with patch.object(recommender, "format_agent_performance", return_value="agent-status") as fmt:
